...
<img src="./src/assets/sponge-rizz.png ">

## Documentation ✏️

- Github: [react-webcam](https://github.com/mozmorris/react-webcam)
- Demo: [https://codepen.io/mozmorris/pen/JLZdoP](https://codepen.io/mozmorris/pen/JLZdoP)
- npm: [react-webcam](https://www.npmjs.com/package/react-webcam)
- Webcam component for React. See [http://caniuse.com/#feat=stream ](http://caniuse.com/#feat=stream)for browser compatibility.
- [@vitejs/plugin-react](https://github.com/vitejs/vite-plugin-react/blob/main/packages/plugin-react/README.md) uses [Babel](https://babeljs.io/) for Fast Refresh
- [@vitejs/plugin-react-swc](https://github.com/vitejs/vite-plugin-react-swc) uses [SWC](https://swc.rs/) for Fast Refresh

_Note: Browsers will throw an error if the page is loaded from insecure origin. I.e. Use https._
